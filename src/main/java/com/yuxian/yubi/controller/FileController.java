...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        String filepath = generateFilePath(multipartFile, fileUploadBizEnum, loginUser);
        File file = null;
        try {
            // 上传文件
     ...
     * @return
     */
    private String generateFilePath(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum, User loginUser) {
        // 文件目录：根据业务、用户来划分
